# Master Portuguese Translation Catalog for Milestone 1 (ATRIUM Desktop)
# Covers Swing .form XML files, initComponents(), JOptionPane dialogs, ToolRegistry, and UI classes.
